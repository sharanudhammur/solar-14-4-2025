...
export const metadata = getMetaInfo("Brochure")

export default function Brochure() {
  return (
    <div className="brochure-component" >
      <LayoutContainer bgColor="">
        <h2 className="title" data-aos="fade-left" data-aos-duration="700">Download Our Company Brochure</h2>
        <p className="desc" data-aos="fade-left" data-aos-duration="700">
        ...
        <div className="brochure-wrapper" data-aos="fade-left" data-aos-duration="700">
