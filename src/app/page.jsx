          ...
          >
            <div>
              ...
              <div className="content">
                <div className="desc">
                  Discover a wide range of high-quality solar products designed to meet the latest BIS standards and customizable to suit your needs. Established in Bengaluru in 2004, <span style={{ fontWeight: 600 }}>ROYAL DIRT BLAZE</span> is a pioneer in ETC and FPC-based solar water heaters. We proudly introduced the advanced Ceramic Coated System using world-class technology. Explore our full range under one trusted brand—solar water heaters, electric geysers, RO water purifiers, and heat pumps—all at attractive prices with guaranteed performance.
                </div>
              </div>
            </div>
            <img
              src={onlyLogoImage.src}
              alt=""
              className="only-logo-image"
            />
          </div>
        </div>
      </LayoutContainer>
