...
import bannerImage1 from "@/Assets/gallery-images/bannerImage1.jpeg"; // Step 1: import path
...
const images = [
  ...
  // require('@/Assets/gallery-images/gallery-image (10).jpeg'),
    ...
    <>
      <LayoutContainer bgColor="#fff">
        <div className="company-gallery">
          <h2 className="title" data-aos="fade" data-aos-duration="700">
            Gallery: Our Photoss
          </h2>
          <p className="subtitle" data-aos="fade" data-aos-duration="700">
