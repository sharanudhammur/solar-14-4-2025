...
export const metadata = getMetaInfo("Products")
      ...
      <div className="products-page">
        ...
        <LayoutContainer>
          <div className="product-options-wrapper">
            <div className="product-option" data-aos="fade-left" data-aos-duration="700">
            ...
            <div className="product-option" data-aos="fade-left" data-aos-duration="700" data-aos-delay={200}>
