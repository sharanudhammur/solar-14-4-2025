...
export const metadata = getMetaInfo("About")
        ...
        <section className="section1" data-aos="fade-left">
          ...
          <div className="about-section about-section1">
            <div className="content">
              ...
              <p className="desc">
                ...
                trust and faith in all the customers. We at <span style={{ color: "#3182ce", fontWeight: 500 }}>
                  "SHIVA SAI SOALR SLYSTEM"
                </span> have the latest infrastructure & equipment for
          ...
          <div className="about-section about-section2">
            ...
            <div className="content" data-aos="fade-left">
              <p className="desc">
                We are a leading technology and production enterprise, dedicated to delivering unmatched quality and complete customer satisfaction. <span style={{ color: "#3182ce", fontWeight: 500 }}>ISO 9001:2008 certified</span>, we maintain a strong focus on innovation and service excellence. We proudly meet global standards in both quality and technology, ensuring our clients always receive the best.
              </p>
              <p className="desc">
          ...
          <div className="experience-section">
            <div className="each-card">
              <div className="text">
                <Counter start={0} end={8} duration={3} text="+" />
              </div>
              <div className="label">Years Experience</div>
            </div>
            <div className="each-card">
              <div className="text">
                <Counter start={4950} end={5000} duration={3} text="+" />
              </div>
              <div className="label">Happy Customers</div>
            </div>
            <div className="each-card">
              <div className="text">
                <Counter start={0} end={100} duration={3} text="+" />
              </div>
              <div className="label">Projects Completed</div>
            </div>
            <div className="each-card">
              <div className="text">
                <Counter start={0} end={15} duration={3} text="+" />
              </div>
